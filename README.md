...
- **Training Strategy:** Full Dataset Training
- **Epochs:** 50
...
2. **Submit Job:** Once the data pipeline is complete, submit the training job via SLURM if you're using the HPC:
   ```bash
...
3. **Monitor:** Track progress in the logs:
   ...
   ```
**Note:** If you don't use the HPC at Oregon State, ignore submit_job.sh.
